...
MODEL_PATH = 'models/autogluon_bsp_v22_refined'
TRAIN_ROWS = 2000000 

print("LOADING DATA for V22 (Refined Pure Form)...")
...
# --- FEATURE ENGINEERING (V3 Inspired) ---
...
# Feature Lists
for w in [3, 10]:
    # BSP Stats (Handling NaNs implicitly in Pandas rolling)
    ...
    # Position Stats (Class)
    # Convert Pos to numeric is already done.
