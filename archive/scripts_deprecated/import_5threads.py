"""
Robust BSP + Price5Min Import - 5 Threads
==========================================
Same as import_robust.py but with 5 worker threads for faster processing.
...
def main():
    print("="*70)
    print("ROBUST BSP + P5 IMPORT (5 Threads, Feb 2025 backwards)")
    print("="*70)
    ...
    for year in [2025, 2024, 2023, 2022, 2021, 2020]:
        for month in range(12, 0, -1):
            if year == 2025 and month > 2:  # Start from Feb 2025
                continue
