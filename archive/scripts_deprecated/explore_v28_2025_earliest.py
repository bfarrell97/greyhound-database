# explore_v28_2025_earliest.py
"""
Evaluate the V28 AutoGluon model on the entire year 2025 using the earliest
...
simulation with a value threshold of 50% and a maximum stake price of $10.
"""
import sqlite3
import pandas as pd
import numpy as np
...
# Ensure columns exist; missing columns will be created with NaN
...
print("=== V28 2025 (Earliest Price) Evaluation ===")
print(f"Races: {races:,}")
