"""
V28 - Betfair Tutorial Implementation
=====================================
Implements the exact feature engineering from the Betfair Down Under tutorial:
https://github.com/betfair-down-under/autoHubTutorials/tree/master/greyhoundModelling

Key Features:
- Normalized times (vs Track/Distance median)
- Rolling window stats (28D, 91D, 365D) x (min, max, mean, median, std)
- Box win percentages
- Speed index

Uses AutoGluon instead of individual sklearn models (ensembles them all).
"""
import sqlite3
import pandas as pd
import numpy as np
...
def train_v28():
    print("="*70)
    print("V28 - BETFAIR TUTORIAL MODEL (Rolling Window Features)")
    print("="*70)
    ...
    save_path = 'models/autogluon_v28_tutorial'
    ...
    predictor = TabularPredictor(
        ...
        time_limit=1800,  # 30 mins for high quality
        presets='high_quality'
    )
    
    # ===== EVALUATION =====
    print("\n" + "="*70)
    print("V28 EVALUATION REPORT")
    print("="*70)
