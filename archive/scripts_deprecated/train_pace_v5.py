"""
Pace Model V5 - New Features: Age, Closing Speed, Position Delta
=================================================================
Builds on V4 + adds:
1. Age features (months, peak, declining)
2. Closing Speed (late race pace)
3. Position Delta (positions gained/lost)
4. SecondSplit features
5. Weight features
...
def train_v5_model():
    print("="*70)
    print("PACE MODEL V5 - AGE, CLOSING SPEED, POSITION DELTA")
    print("="*70)
    ...
    with open('models/pace_v5_age_closing.pkl', 'wb') as f:
        pickle.dump(model_artifacts, f)
    print("Saved to models/pace_v5_age_closing.pkl")
    print("="*70)
