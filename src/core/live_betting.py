"""
Live Betting Manager
Handles production betting via Betfair API
Tracks active bets, settles results, and calculates P/L
"""
...
class LiveBettingManager:
    ...
    def place_bet_record(self, bet_id, market_id, selection_id, price, size, side, market_name, selection_name, race_time=None, strategy=None):
    ...
    def get_placed_dogs_today(self):
    ...
    def get_settled_bets(self, limit=50):
        """Get history"""
        conn = self._get_conn()
