...
def train_v45_test():
    print("Loading FULL DATA (2020-2023) for V45 Drifter TEST Model...")
    ...
    # 5. TEST Training (2020-2023 ONLY)
    # We use 2023 for training "recent context" but limit overall dataset to end of 2023.
    # Actually, we already limited the SQL query to <= 2023-12-31.
    # To mimic "Production" style training (recent bias), we might train on 2022-2023?
    # Or just train on the whole 2020-2023 block?
    # V44 Prod trained on 2023-Present.
    # So V45 Test should probably train on 2022-2023 to be analogous?
    # Or 2021-2023. Let's start with 2021-2023 to get enough data.
    
    df_train = df_clean[df_clean['MeetingDate'] >= '2021-01-01'].copy()
    ...
    print("Training XGBoost V45 TEST Model (2020-2023)...")
    ...
    # Save
    joblib.dump(model, 'models/xgb_v45_test.pkl')
    print("\nTEST Model saved to models/xgb_v45_test.pkl")
