"""
TEST: Threshold 0.55 + $20 Odds Cap
Finding optimal balance between volume and ROI.
...
# TEST THRESHOLDS
BACK_THRESHOLD = 0.55  # Was 0.60
BACK_TRAP_THRESHOLD = 0.70
LAY_THRESHOLD = 0.70
ODDS_CAP = 20.0  # Was 15.0

def run_backtest():
    print("="*80)
    print("TEST: THRESHOLD 0.55 + $20 ODDS CAP")
    print(f"BACK >= {BACK_THRESHOLD} (Trap > {BACK_TRAP_THRESHOLD}), LAY >= {LAY_THRESHOLD}")
    print(f"Odds Cap: ${ODDS_CAP}")
    print("="*80)
