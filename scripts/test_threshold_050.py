"""
TEST: Lower BACK Threshold (0.50)
Comparing to production (0.60) to see volume and ROI impact.
...
# TEST THRESHOLDS
BACK_THRESHOLD = 0.50  # LOWERED FROM 0.60
...
def run_backtest():
    print("="*80)
    print("TEST: LOWER BACK THRESHOLD (0.50)")
